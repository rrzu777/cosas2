...
function wp_cumulus_options() {	
	...
	echo '<td><input type="text" name="tcolor" value="'.$options['tcolor'].'" size="8"></input><br />This should be a 6 character hex color value without the # prefix (000000 for black, ffffff for white)</td></tr>';
	// background color
...
function widget_init_wp_cumulus_widget() {
	...
	function wp_cumulus_widget_control() {
		...
		?>
			...
			<p><label for="wpcumulus_widget_bgcolor"><?php _e('Backgroound color:'); ?> <input class="widefat" id="wpcumulus_widget_bgcolor" name="wpcumulus_widget_bgcolor" type="text" value="<?php echo $bgcolor; ?>" /></label></p>
